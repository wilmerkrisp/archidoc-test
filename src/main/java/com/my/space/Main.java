...
//--------------------------------------------------------------------------------
//
//                          mygradleplugintest  com.my.space
//                           wilmer 2019/01/12
//
//--------------------------------------------------------------------------------
...
import com.my.space.addit.Zavis;
...
public class Main
	...
	public Zavis svoistvo =new Zavis();
	...
	public static void main( final String... p_i )
		{
		System.out.println( "VV_main main " +new Main().svoistvo);
